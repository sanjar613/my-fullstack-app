...
export async function renderHomePage() {
  ...
  try {
    // Fetch knowledge base articles for public view
    const response = await fetch(`${window.API_URL}/kb`);
            ...
            ${articles.slice(0, 6).map(article => `
              <div class="col-lg-4 col-md-6">
                <div class="card h-100 kb-article">
                  <div class="card-body">
                    <h3 class="h5 kb-article-title">${article.title}</h3>
    ...
    // If there's an error, still render the page but without the knowledge base section
    // Rest of the HTML remains the same, just omitting the knowledge base section
  }
